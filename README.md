...
Release 版本号为「霞鹜文楷 GB」「芫荽」「霞鹜文楷 Lite」三款字体版本号的总和（由于 Klee One 作为母字体已基本固定，故其版本号不再计入；由于「霞鹜文楷 TC」与「霞鹜文楷 Lite」同期更新，故文楷 TC 的版本号不计入；各字体三位副版本号后的小版本号不计入，如遇紧急更新修正版本，本项目增加一个小版本号）。
